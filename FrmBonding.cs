...
namespace Cutting
{
    public partial class FrmBonding : Form
    {
        ...
        private void RefresBonding()
        {
            DGV_Grind_todo.DataSource = "";
            

            var Bond = from id in trackdb.Tracks
                       // join idd in trackdb.GlassTypes on id.Glass_ID equals idd.Glass_ID
                        ...
                        where id.Departmet_ID == 61 && id.QTY_ToDo > 0 && id.Recived_From==6
            ...
            DGV_Grind_todo.DataSource = Bond;
        ...
        private void FrmBonding_Load(object sender, EventArgs e)
        {
        ...
        private void btnSelectItem_Click(object sender, EventArgs e)
        {
                ...
                //    else { up.Send_To = 7; }
                //    /////////////////////////////////////////
                //    var Bondype = (from ty in trackdb.Orders where ty.OC_ID == up.OC_ID select new { ty.Bonding_Type }).SingleOrDefault();
                //    var Bondcost = (from pco in trackdb.Processes where pco.ID == Bondype.Bonding_Type select new { pco.Pocess_Cost }).SingleOrDefault();
                //    /////////////////////////////////////////
        ...
        {
            Frm_Reject rej = new Frm_Reject();
            rej.MdiParent = this.MdiParent;
            rej.Show();
        }
        ...
        {
            if (txt_qtysend_grind.Text == ""  || txt_oc_grind.Text == "")
            ...
            else
            {
                ...
                foreach (Track up in work)
                {
                    ...
                    else
                    {
                        ...
                        add.Pos = up.Pos;
                        add.Glass_ID = up.Glass_ID;
                        if (up.IGU == "") { add.IGU = "Bonding to frame [ " + up.IGU + " ]"; }
                        else {add.IGU= "Bonding to frame ( " + txt_glaa_grind + " )"; }//"Bonding to frame ( " + txt_glass_IGU1.Text + " )";
                        ...
                        ///////////
                        add.Standard_Unit_Process_Cost = Bondcost.Pocess_Cost;
                        add.ProcessType = Bondype.Bonding_Type;
        ...
        private void btnFinishGrind_Click(object sender, EventArgs e)
        {
            var track = from id in trackdb.Tracks
                       // join idd in trackdb.GlassTypes on id.Glass_ID equals idd.Glass_ID
                        ...
                        where (id.Date <= dateToGrind.Value && id.Date >= datefromGrind.Value) && id.Recived_From == 61
                        select new
                        {
